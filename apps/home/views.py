...
def chat_bot(request):
    """Handle chatbot messages using Google AI Studio (Gemini API)"""
    try:
        ...
        system_prompt = "You are a helpful medical assistant for Swift Care, a healthcare application. Provide clear, accurate, and concise medical information while reminding users to consult healthcare professionals for serious concerns."
